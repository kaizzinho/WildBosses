      ...
      for (const moveid of moves) {
        ...
        if (!cull && !isSetup && moveIsRejectable && (counter.setupType || !move.stallingMove)) {
          if (
            ...
            (moves.has("sunnyday") && movePool.includes("solarbeam") || moves.has("solarbeam") && movePool.includes("sunnyday")) || ["milkdrink", "recover", "spikes", "spore"].some((m) => movePool.includes(m))
          ) {
            cull = true;
          } else {
