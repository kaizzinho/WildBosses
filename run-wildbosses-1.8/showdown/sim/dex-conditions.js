...
class DexConditions {
  ...
  getByID(id) {
    ...
    } else if ((found = this.dex.moves.getByID(id)).exists && found.condition || (found = this.dex.abilities.getByID(id)).exists && found.condition || (found = this.dex.items.getByID(id)).exists && found.condition) {
